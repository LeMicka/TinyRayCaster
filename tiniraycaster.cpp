...
void drawRectangle (std::vector<uint32_t> &img, const size_t img_w, const size_t img_h, const size_t x, const size_t y, const size_t w, const size_t h, const uint32_t color) {
...
int main() {
	...
	for (size_t j = 0; j < map_h; j++) { // draw the map
		for (size_t i = 0; i < map_w; i++) {
			...
			drawRectangle(framebuffer, win_w, win_h, rect_x, rect_y, rect_w, rect_h, packColor(0, 255, 255));
		}
	}
